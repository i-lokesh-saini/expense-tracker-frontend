...
const Input = ({ value, onChange, placeholder, label, type, UsedIn}) => {
    ...
    return (
    <div>
        <label className={`text-[13px] text-slate-800 ${UsedIn == "AddIncomeForm" || "AddExpenseForm" ? "dark:text-white" : "text-slate-800"}`}>{label}</label>
