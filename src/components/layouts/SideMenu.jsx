...
import CharAvatar from "../card/CharAvtar"
...
const SideMenu = ({ activeMenu }) => {
    ...
    return (
        <div className="w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/50 backdrop-blur-[2px] py-5 sticky top-15.25 z-20">
            <div className="flex flex-col items-center justify-center gap-3 mb-7">
                {user?.profileImageUrl ? (
                    <img src={user?.profileImageUrl || ""} alt="Profile Image" className="w-20 h-20 bg-slate-400 rounded-full object-cover text-center" />
